...
inline static bool isSubstring(const std::string &string,
...
//! Macros to capture stdout and stderr and assign output directly to
//! std::string or suppress output
#define LPP_CAPTURE_STDOUT(x)                      \
  []() {                                           \
...
inline int ForkAndReap(int *Ws, const std::function<void()> &fn) {
  ...
  while (true) {
    if (waitpid(pid, Ws, WUNTRACED) < 0) {
      ...
      abort();
    } else if (!WIFEXITED(*Ws) && !WIFSIGNALED(*Ws)) {  // shouldn't have
                                                        // stopped
...
inline static constexpr const char *ERROR_MESSAGE =
    "Base angle (%f) is less than the minimum angle (%f)";
inline static const std::string EXPECTED_ERROR_MESSAGE =
    "Base angle (3.300000) is less than the minimum angle (5.500000)\n";
}  // namespace testing
...
namespace rosprintf {
inline static const std::string debug =
    "\x1B[m[DEBUG] [.]: Base angle (.) is less than the minimum angle "
    "(.)\x1B[m\n";
inline static const std::string info =
    "\x1B[m[ INFO] [.]: Base angle (.) is less than the minimum angle "
    "(.)\x1B[m\n";
inline static const std::string warning =
    "\x1B[m[ WARN] [.]: Base angle (.) is less than the minimum angle "
    "(.)\x1B[m\n";
inline static const std::string error =
    "\x1B[m[ERROR] [.]: Base angle (.) is less than the minimum angle "
    "(.)\x1B[m\n";
inline static const std::string fatal =
    "\x1B[m[FATAL] [.]: Base angle (.) is less than the minimum angle "
    "(.)\x1B[m\n";
namespace v2 {
...
namespace logstr {
inline static const std::string info =
    "\x1B[m[ INFO] [.]: LOG_STRING: collected info\x1B[m\n";
inline static const std::string warning =
    "\x1B[m[ WARN] [.]: LOG_STRING: collected warn\x1B[m\n";
inline static const std::string error =
    "\x1B[m[ERROR] [.]: LOG_STRING: collected error\x1B[m\n";
inline static const std::string fatal =
    "\x1B[m[FATAL] [.]: LOG_STRING: collected fatal\x1B[m\n";
namespace v2 {
inline static const std::string info =
    "\x1B[m[INFO] [.]: LOG_STRING: collected info\x1B[m\n";
inline static const std::string warning =
