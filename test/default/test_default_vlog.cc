...
TEST(default_vlog, glog_syntax_severity_if_v5) {
  LOG_INIT(*test_argv);
  FLAGS_v = 3;
...
TEST(default_vlog, glog_syntax_severity_ifnot_v1) {
  LOG_INIT(*test_argv);
  FLAGS_v = 3;
...
TEST(default_vlog, glog_syntax_severity_ifnot_v3) {
  LOG_INIT(*test_argv);
  FLAGS_v = 3;
...
TEST(default_vlog, glog_syntax_severity_ifnot_v5) {
  LOG_INIT(*test_argv);
  FLAGS_v = 3;
